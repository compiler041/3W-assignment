    ...
    <Box sx={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: 18, color: 'rgba(255,255,255,0.8)', textAlign: 'center', maxWidth: 400, lineHeight: 1.7 }}>
          Earn real money online through simple, reliable digital tasks. Join thousands of earners today!
        </Typography>
      </Box>
      ...
      <Box sx={{
        ...
        <Typography sx={{ fontSize: 28, fontWeight: 800, color: '#1a1a1a', mb: 0.5 }}>Welcome Back</Typography>
        <Typography sx={{ fontSize: 15, color: '#999', mb: 4 }}>Log in to continue earning!</Typography>
        ...
        <Typography sx={{ textAlign: 'center', mt: 3, fontSize: 14, color: '#999' }}>
          ...
          <Link to="/signup" style={{ color: '#2979ff', fontWeight: 700 }}>Sign up</Link>
        </Typography>
      </Box>
    </Box>
  );
